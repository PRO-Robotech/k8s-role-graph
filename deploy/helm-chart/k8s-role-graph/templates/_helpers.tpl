...
*/}}
{{- define "k8s-role-graph.fullname" -}}
...
Selector labels
*/}}
{{- define "k8s-role-graph.selectorLabels" -}}
app.kubernetes.io/name: {{ include "k8s-role-graph.name" . }}
